...
operation=ScheduleTaskSiteController::enable
...
service=ScheduleTaskSite4Controller
operation=ScheduleTaskSite4Controller::setScheduleTaskService
params=[scheduleTaskService:ScheduleTaskService]
output=void
using-types=[ScheduleTaskService]

operation=ScheduleTaskSite4Controller::disable
params=[id:Long, objectVersionNumber:Long]
output=void
using-types=[ScheduleTaskService, Long, ResourceLevel]
