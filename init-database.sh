...
java -Dspring.datasource.url="jdbc:mysql://localhost:3308/?serverTimezone=CTT&useUnicode=true&characterEncoding=utf-8&useSSL=false&useInformationSchema=true&remarks=true" \
